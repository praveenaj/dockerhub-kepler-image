...
$resultCount = $allsearch ->found_posts;
			...
			<div class="article-wrapper">
				<div class="full-width no-margin">
					<header class="post-filter-wrapper">
						...
						<p class="hint-text"><?php esc_html__('Showing page','kepler_theme') ?> <?php echo esc_html($currentPage) ?> <?php esc_html__('of','kepler_theme') ?> <?php echo esc_html($resultCount); ?> results</p>
						<h4 class="page-title"><?php printf( esc_html__( 'Search Results for: %s', 'kepler_theme' ), '<span>' . get_search_query() . '</span>' ); ?></h4>
					</header>
					<div class="row">
